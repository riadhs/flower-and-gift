...
// // ✅ unique key per product + variant
...
//     // ✅ subtotal uses the selected variant price already stored in product.price
...
// // ✅ export helper if you want to use it in CartPage too
// export { getCartKey };
