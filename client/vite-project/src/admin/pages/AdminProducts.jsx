...
//     setLoading(true);
//     try {
//       // IMPORTANT: api baseURL is "/api"
//       // so this becomes "/api/admin/products"
...
//                 Active: {String(p.is_active ?? p.isActive ?? "")}
//               </div>
//             </div>
...
//                 Delete
//               </button> */}
//               <button onClick={() => deactivateProduct(p.id)}>Deactivate</button>
// <button
